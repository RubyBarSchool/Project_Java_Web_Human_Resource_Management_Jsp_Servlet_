<%-- 
    Document   : ChiTietTienLuong
    Created on : Apr 2, 2020, 7:37:35 PM
    Author     : lenovo
--%>
        ...
        <div class="container-fluid" >
            ...
            <div class=" full row-cols-5">
                ...
                <div class="float-right col-10"  >
                    <h4 class="text-center">Tiền Lương</h4>
                    <p></p>
                    <table class="table" >
                        <c:set var="nv1" value="${requestScope.nhanVien}" ></c:set>
                            <tr>
                                <td>ID</td>
                                <td >${nv1.nv.id}</td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td rowspan="${nv1.ngayDiLam.size()+1}" >Ngay Di Lam</td>
                            <c:forEach items="${nv1.ngayDiLam}" var="cc" >
                            <tr>
                                <c:set value="1" var="check" ></c:set>
                                <td><fmt:formatDate value="${cc}" pattern="dd/MM/yyyy" ></fmt:formatDate></td>
                                </tr>
                        </c:forEach>
