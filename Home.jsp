<%-- 
    Document   : ThemMoiChungChi
    Created on : Apr 1, 2020, 7:24:36 PM
    Author     : lenovo
--%>
    ...
    <body>
        <div class="container-fluid" >
            ...
            <div class="float-right col-9"  >
                <ul class="pagination">
                        <li class="page-item active"><a class="page-link" href="home"></a></li>
                        <li class="page-item"><a class="page-link" href="home?id=2"></a></li>
                    </ul>
                <h5></h5>
                <h5 class="text-center">Hải Sản Tươi Sống ,Sạch Sẽ , Chất Lượng</h5>
                <div id="demo" class="carousel slide" data-ride="carousel">
                    ...
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            <img src="image/4.jpg" alt="a" width="900" height="500">
                        </div>
                        <div class="carousel-item">
                            <img src="image/5.jpg" alt="b" width="900" height="500">
                        </div>
                        <div class="carousel-item">
                            <img src="image/6.jpg" alt="c" width="900" height="500">
                        </div>
                        <div class="carousel-item">
                            <img src="image/7.jpg" alt="d" width="900" height="500">
                        </div>
                        <div class="carousel-item">
                            <img src="image/8.jpg" alt="e" width="900" height="500">
                        </div>
