<%-- 
    Document   : DanhSachLaoDongVaTienLuong
    Created on : Apr 2, 2020, 6:45:11 PM
    Author     : lenovo
--%>
                ...
                <div class="float-right col-10"  >
                    <table border="1px" class="table-responsive" >
                        ...
                        <c:forEach items="${requestScope.arrAllNhanVien}" var="nv1" >
                            <tr>
                                <td><a href="chi_tiet_tien_luong?idnv=${nv1.id}" >${nv1.id}</a> </td>
                                <td><a href="chi_tiet_tien_luong?idnv=${nv1.id}" >${nv1.name}</a> </td>
                                <c:set value="0" var="check" ></c:set>
                                <c:forEach items="${tienluong}" var="tl" >
                                    <c:if test="${tl.nv.id eq  nv1.id}" >
