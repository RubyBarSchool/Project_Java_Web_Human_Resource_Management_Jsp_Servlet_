<%-- 
    Document   : DanhSachChungChi
    Created on : Apr 1, 2020, 7:00:37 PM
    Author     : lenovo
--%>
        ...
        <div class="container-fluid" >
            ...
            <div class=" full row-cols-5">
                ...
                <div class="float-right col-10"  >
                    <h4 class="text-center">Danh Sách Chứng Chỉ</h4>
                    <p></p>
                    <form action="danh_sach_chung_chi" method="POST" >
                        ...
                        Loai: <input type="text" name="loai" value="${x.loai}" />
                        So Hieu: <input type="text" name="sohieu" value="${x.soHieu}" />
                        <input type="submit" value="Search" />
                    </form>
                    <p></p>
                    <a href="them_moi_chung_chi" ><button>Them Moi Chung Chi</button></a>
                    <table class="table">
                        <tr>
                            <td>ID</td>
                            <td>Name</td>
