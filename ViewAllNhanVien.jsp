<%-- 
    Document   : ViewAllNhanVien
    Created on : Mar 31, 2020, 6:07:47 PM
    Author     : lenovo
--%>
        ...
        <div class="container-fluid" >
            ...
            <div class=" full row-cols-5">
                ...
                <div class="float-right col-10"  >
                    <h4 class="text-center">Danh Sách Toàn Nhân Viên Công Ty</h4>
                    <p></p>
                    <form action="danh_sach_nhan_vien" method="POST" >
...
<!--                        DanToc: <input type="text" name="dantoc" value="${x.danToc}" /><br/><br/>-->
                        <p></p>
                        <input  type="submit" value="Search" />

                    </form>
                    <p></p>
                    <a href="tuyen_dung_nhan_vien" ><button>Tuyen Dung Nhan Vien</button></a><br/>
                    <table class="table">
                        <tr>
                            <td>ID</td>
                            <td>Name</td>
                        ...
                        <c:forEach items="${requestScope.arrAllNhanVien}" var="arrnv" >
                            <tr>
                                ...
                                <td>${arrnv.danToc}</td>
                                <td><a href="update_nhan_vien?idnv=${arrnv.id}" >Edit</a></td>
                            </tr>
                        </c:forEach>
                        <c:forEach items="${requestScope.arrSearch}" var="arrnv" >
                            <tr>
                                <td>${arrnv.id}</td>
                                <td> <a href="chi_tiet_nhan_vien"> ${arrnv.name} </a> </td>
                                <td>${arrnv.address}</td>
                                <td>${(arrnv.gender)?"Nam":"Nu"}</td>
                                <td>${arrnv.danToc}</td>
                                <td><a href="update_nhan_vien?idnv=${arrnv.id}" >Edit</a></td>
