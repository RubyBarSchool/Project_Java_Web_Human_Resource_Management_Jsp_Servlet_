        ...
        <div class="container-fluid" >
            ...
            <div class=" full row-cols-5">
                ...
                <div class="float-right col-10"  >
                    <form action="them_moi_chung_chi" method="POST" >
                        ID: <input type="text" name="id"/><br>
                        Name: <input type="text" name="name" /><br>
                        Loai: <input type="text" name="loai" /><br>
                        So Hieu: <input type="text" name="sohieu" /><br>
                        <input type="submit" value="Them Chung Chi" />
                    </form>
                </div>
            </div>
        </div>
