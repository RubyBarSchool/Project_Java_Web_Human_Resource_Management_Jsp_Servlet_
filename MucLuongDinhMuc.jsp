<%-- 
    Document   : MucLuongDinhMuc
    Created on : Apr 2, 2020, 12:04:36 AM
    Author     : lenovo
--%>
        ...
        <div class="container-fluid" >
            ...
            <div class=" full row-cols-5">
                ...
                <div class="float-right col-10"  >
                    <h4 class="text-center">Mức Lương Định Mức</h4>
                    <p></p>
                    <form action="danh_sach_thang_bac_luong" method="POST" >
                        ...
                        Muc Luong: <input type="text" name="mucluong" value="${x.mucLuong}" />
                        <p></p>
                        <input type="submit" value="Search" />
                    </form>
                    <p></p>
                    <a href="them_moi_bac_luong" ><button>Them moi muc luong</button></a>
                    <table class="table">
                        <tr>
                            <td>ID</td>
                            <td>Name</td>
                        ...
                        <c:forEach items="${requestScope.capbaccongty}" var="arrnv" >
                            <tr>
                                <td>${arrnv.id}</td>
                                <td>  ${arrnv.name} </td>
                                <td>${arrnv.mucLuong}</td>
                                <td><a href="update_luong?idnv=${arrnv.id}">Edit</a></td>
                            </tr>
                        </c:forEach>
