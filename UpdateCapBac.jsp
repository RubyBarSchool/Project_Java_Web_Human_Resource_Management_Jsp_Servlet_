<%-- 
    Document   : UpdateCapBac
    Created on : Apr 2, 2020, 1:15:47 AM
    Author     : lenovo
--%>
        ...
        <div class="container-fluid" >
            ...
            <div class=" full row-cols-5">
                ...
                <div class="float-right col-10"  >
                    ...
                    <form action="update_luong" method="POST" >
                        <c:set value="${requestScope.capbaccongty}" var="nv" ></c:set>
                        ID: <input type="text" readonly value="${nv.id}" name="id"/><br>
                        Name: <input type="text" value="${nv.name}"  name="name" /><br>
                        Muc Luong: <input type="text" value="${nv.mucLuong}"  name="mucluong" /><br>
