<%-- 
    Document   : UpdateChungChi
    Created on : Apr 1, 2020, 7:40:08 PM
    Author     : lenovo
--%>
        ...
        <div class="container-fluid" >
            ...
            <div class=" full row-cols-5">
                ...
                <div class="float-right col-10"  >
                    ...
                    <form action="update_chung_chi" method="POST" >
                        <c:set value="${requestScope.chungchi}" var="nv" ></c:set>
                        ID: <input type="text" readonly value="${nv.id}" name="id"/><br>
                        Name: <input type="text" value="${nv.name}"  name="name" /><br>
                        Loai: <input type="text" value="${nv.loai}"  name="loai" /><br>
                        So Hieu <input type="text" value="${nv.soHieu}"  name="sohieu" /><br>
