<%-- 
    Document   : ViewDetailNhanVien
    Created on : Apr 1, 2020, 12:33:26 AM
    Author     : lenovo
--%>
        ...
        <div class="container-fluid" >
            ...
            <div class=" full row-cols-5">
                ...
                <div class="float-right col-9"  >
                    <table class="table" >
                        <c:set var="nv" value="${requestScope.nhanvien}" ></c:set>
                            <tr>
                                <td>ID</td>
                                <td >${nv.id}</td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td  >${nv.chungMinhThu}</td>
                        </tr>
                        <tr>
                            <td>Date Of Birth</td>
                            <td  > <fmt:formatDate  pattern="dd/MM/yyyy" value="${nv.dob}" ></fmt:formatDate> </td>
                            </tr>
                            <tr>
                                <td>Dan Toc</td>
                                <td  >${nv.danToc}</td>
                        ...
                        <tr>
                            <td>Cap Bac Cong Ty</td>
                            <td  >${nv.cbcongty.name}</td>
                        </tr>

                        <c:if test="${nv.arrChungChi.size()!=0}" >
                            <tr>
                                <td rowspan="${nv.arrChungChi.size()+1}" >Chung Chi</td>

                                <c:forEach items="${nv.arrChungChi}" var="cc" >
                                <tr>
                                    <td>${cc.name}</td>
                                </tr>
                            </c:forEach>
                        ...
                        <tr>
                            <td>Cong Viec</td>
                            <td colspan="4" >${nv.congViec.name}</td>
                        </tr>
                    </table>
                </div>
            </div>
